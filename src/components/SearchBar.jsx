  ...
  return (
    <div className="relative flex-grow md:flex-grow-0 md:w-64">
      <motion.input
        ...
        className="w-full pl-12 pr-4 py-2 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-300 shadow-sm hover:shadow-lg search-input"
